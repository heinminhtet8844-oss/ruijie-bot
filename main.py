...
# ===== Render Free Tier အတွက် Web Server ဆောက်ခြင်း =====
app = Flask('')
...
# ===== သင်၏ မူလ Bot ကုဒ်များ =====
BOT_TOKEN = "8801899210:AAG7tA3K0z847-DwOQC0M_goARef0rKmLok"
ADMIN_ID = 1901101365
...
if __name__ == '__main__':
    # Web server အား Background တွင် အရင်နှိုးခြင်း (Render ပိတ်မသွားစေရန်)
